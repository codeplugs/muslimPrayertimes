...
function fetchTimings() {
  ...
  //document.getElementById("demo").innerHTML = "Your Location: " + x;
   document.getElementById("demo").innerHTML = "Your Location: ";

  // Mendapatkan data jadwal
  const apiURL = `https://api.aladhan.com/v1/timingsByAddress/${dd}-${mm}-${yyyy}?address=${x}`;
